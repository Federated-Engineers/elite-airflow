nordic_data = [{"finance_spreadsheet": "1vQFb4E7QEpVRkpRe34CyGfaH9VJRFVZpFLAc7taYYwg"}]

SHEETS = [
    {"name": "marketing",   "id": "13ULiowSb4JuNIaLldstlNB7sqr1WBe0Yrjm8ALEyLQ0", "s3_folder": "marketing", "unique_keys": ["date", "product_id", "platform"]},
