...
from business_logic.liffey_luxury.transform import check_and_write_data_to_s3
...
with DAG(
    ...
    write_transformed_data_to_s3 = PythonOperator(
        task_id="write_transformed_data_to_s3",
